<template>
  <v-container fluid>
    ...
    <v-data-iterator :items="items" :sort-by.sync="sortBy.prop" :sort-desc.sync="sortBy.desc" :custom-sort="customSort">
...
export default {
  ...
  methods: {
    customSort(items, sortBy, sortDesc, locale, customSorters) {
      ...
      console.log('sortBy:', sortBy, 'sortDesc:', sortDesc, 'locale:', locale)
      console.log('customSorters:', customSorters)
      return items
    }
  }
}
